...
max_groups_per_topic = int(sys.argv[4])
if sys.argv[5] == 'None':
    ideal_size = 0
    deviation_multiplier = 0
else:
    ideal_size = int(sys.argv[5])
    deviation_multiplier = 10
students = ast.literal_eval(sys.argv[6])
topics = ast.literal_eval(sys.argv[7])
